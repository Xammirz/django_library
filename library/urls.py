...
urlpatterns = [
    ...
    path(
        "adminactionauthor/",
        views.AdminActionAuthorView.as_view(),
        name="admin_action_author",
    ),
    path("author/create/", views.AuthorCreate.as_view(), name="author-create"),
    path("author/update/<int:pk>",
         views.AuthorUpdate.as_view(),
         name="author-update"),
    path("author/delete/<int:pk>",
         views.AuthorDelete.as_view(),
         name="author-delete"),
    path(
        "adminactionbook/",
        views.AdminActionBookView.as_view(),
        name="admin_action_book",
    ),
    ...
    path("api/v1/books/<int:pk>",
         BookDetailViewAPI.as_view(),
         name="book_detail_api"),
    path("api/v1/authors/",
         AuthorListViewAPI.as_view(),
         name="author_list_api"),
    path(
        "api/v1/authors/<int:pk>",
        AuthorDetailViewAPI.as_view(),
